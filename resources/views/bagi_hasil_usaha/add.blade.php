...
<div class="container p-4">
    ...
    <div class="card p-4" style="width:100%;">
        <div class="card-body">
            <form action="{{ url('administrator/bagi-hasil-usaha/create') }}"  method="POST" >
                @csrf
               
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Jenis Bagi Hasil</label>
                    <div class="col-sm-10">
                        <input type="text"  class="form-control" name="jenis_bagi_hasil" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="id_mitra" class="form-control" id="" required>
                            ...
                            @foreach($mitra as $v_mitra)
                                <option value="{{ $v_mitra->id_mitra }}">{{ $v_mitra->nama_mitra }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
